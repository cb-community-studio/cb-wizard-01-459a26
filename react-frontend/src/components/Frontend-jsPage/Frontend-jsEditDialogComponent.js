...
const Frontend-jsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("frontend-js").patch(_entity._id, _data);
            props.onHide();
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="frontend-js-edit-dialog-component">
                <div>
                    <p className="m-0" >Frontend Framework:</p>
...
export default connect(null, mapDispatch)(Frontend-jsCreateDialogComponent);
