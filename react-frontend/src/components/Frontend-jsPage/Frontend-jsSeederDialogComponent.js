...
import seederData from "./frontend-js.seeder.json";
...
const Frontend-jsSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(Frontend-jsSeederDialogComponent);
