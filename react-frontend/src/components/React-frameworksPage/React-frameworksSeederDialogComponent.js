...
import seederData from "./react-frameworks.seeder.json";
...
const React-frameworksSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(React-frameworksSeederDialogComponent);
