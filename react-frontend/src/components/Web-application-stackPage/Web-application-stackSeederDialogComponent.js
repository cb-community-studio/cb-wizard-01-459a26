...
import seederData from "./web-application-stack.seeder.json";
...
const Web-application-stackSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(Web-application-stackSeederDialogComponent);
