...
import seederData from "./svelte-frameworks.seeder.json";
...
const Svelte-frameworksSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(Svelte-frameworksSeederDialogComponent);
