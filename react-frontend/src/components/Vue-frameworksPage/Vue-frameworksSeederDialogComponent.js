...
import seederData from "./vue-frameworks.seeder.json";
...
const Vue-frameworksSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(Vue-frameworksSeederDialogComponent);
