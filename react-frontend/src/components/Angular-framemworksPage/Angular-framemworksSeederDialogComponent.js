...
import seederData from "./angular-framemworks.seeder.json";
...
const Angular-framemworksSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(Angular-framemworksSeederDialogComponent);
